...
const DeleteAccountModal = () => {
  const { setShowDeleteAccountModal, selectedUser, axios } = useAppContext();
  ...
  return (
    ...
    >
      <div
        className="flex flex-col items-center bg-white shadow-md rounded-xl py-6 px-5 md:w-[480px] w-[390px] border border-gray-200"
